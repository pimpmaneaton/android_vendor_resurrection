...
changelog_path_name=vendor/rr/CHANGELOG.mkdn #changelog file path/name.extension
source_name="Resurrection Remix Oreo" #Name to display in changelog.md top before version
# input variables end
...
echo ""
echo >> $Changelog
echo "# $source_name Version 6.0.0 Changelog"    >> $Changelog;
echo '' >> $Changelog;
echo >> $Changelog;
